...
function Selection() {
    ...
    this.getUsername = function () {
        return localStorage[OU_USERNAME_KEY]
            ? localStorage[OU_USERNAME_KEY]
            : ''
    }
    ...
    this.sync = function (server, fn) {
        ...
        if (server) {
            ...
            $.post(
                organisationUnitTreePath + 'getselected.action',
                function (data) {
                ...
                $.ajax({
                    ...
                    .done(function () {
                        ...
                        if (multipleSelectionAllowed) {
                            ...
                            $.post(
                                organisationUnitTreePath + 'setorgunit.action',
                                {
                                    id: selected,
                                }
                            ).always(function () {
    ...
    this.clear = function () {
        ...
        $.post(organisationUnitTreePath + 'clearselected.action').always(
            ...
            $.ajax({
                ...
                .done(function (data) {
                    if (data.realRoot === undefined) {
                        selection
                            .getAllPartialOrganisationUnits()
                            .done(function (all) {
                                $.extend(all, data.organisationUnits)

                                selection
                                    .setPartialOrganisationUnits(all)
                                    .done(function () {
                                        $.extend(
                                            organisationUnits,
                                            data.organisationUnits
